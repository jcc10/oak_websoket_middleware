 ...
 */
export type wsHandler = (socket: WebSocket, url: URL, headers: Headers) => Promise<void>;
 ...
 */
export class WebSocketMiddlewareHandler extends Middleware.Middleware<wsHandler> {
